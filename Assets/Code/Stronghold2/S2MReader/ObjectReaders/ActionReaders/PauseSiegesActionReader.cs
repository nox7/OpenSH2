...
{
  internal class PauseSiegesActionReader : ActionReader
  {
    public PauseSiegesActionReader(S2Object obj) : base(obj)
    {
    ...
    {
      PauseSiegesAction obj = new();

      ReadActionHeader(reader);
      ReadDataPayloadMarker(reader, false);

      obj.SiegesNearFlagColor = (FlagColor)reader.ReadInt32();
      obj.SiegesNearFlagNumber = reader.ReadInt32();
      ...
      obj.ShouldPauseSieges = reader.ReadBoolean();
