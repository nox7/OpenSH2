...
{
  internal class SetWolvesToDefensiveActionReader : ActionReader
  {
    public SetWolvesToDefensiveActionReader(S2Object obj) : base(obj)
    {
    ...
    {
      SetWolvesToDefensiveAction obj = new();
