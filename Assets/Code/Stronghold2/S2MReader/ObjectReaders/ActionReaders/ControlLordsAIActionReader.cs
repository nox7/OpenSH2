...
{
  internal class ControlLordsAIActionReader : ActionReader
  {
    public ControlLordsAIActionReader(S2Object obj) : base(obj)
    {
    ...
    public override S2Object Read(BinaryReader reader)
    {
      ...
      obj.IsPlayerControlled = reader.ReadBoolean();
