...
{
  internal class OtherLordsKillsLordXTriggerReader : TriggerReader
  {
    public OtherLordsKillsLordXTriggerReader(S2Object obj) : base(obj)
    {
    ...
    {
      OtherLordsKillsLordXTrigger obj = new();
