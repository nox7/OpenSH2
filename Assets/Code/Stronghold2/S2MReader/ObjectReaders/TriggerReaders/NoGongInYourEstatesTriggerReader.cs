...
{
  internal class NoGongInYourEstatesTriggerReader : TriggerReader
  {
    public NoGongInYourEstatesTriggerReader(S2Object obj) : base(obj)
    {
    ...
    {
      NoGongInYourEstatesTrigger obj = new();
