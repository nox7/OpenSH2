...
{
  internal class EnemyGoldAcquiredTriggerReader : TriggerReader
  {
    public EnemyGoldAcquiredTriggerReader(S2Object obj) : base(obj)
    {
    ...
    {
      EnemyGoldAcquiredTrigger obj = new();
